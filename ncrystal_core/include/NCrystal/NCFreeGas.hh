...
namespace NCrystal {
  ...
  public:
    ...
    //Convenience version which looks up the mass and cross-sections for
    //standard elements in the NeutronSCL DB:
    FreeGas( double temp_kelvin, const std::string& element_name );
