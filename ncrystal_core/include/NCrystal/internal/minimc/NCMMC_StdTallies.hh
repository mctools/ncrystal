...
namespace NCRYSTAL_NAMESPACE {
  namespace MiniMC {
    ...
    private:
      ...
      static hist_t::size_type determineNbins( TallyFlags f,
                                               hist_t::size_type nbase = 150 )
      {
    ...
    public:
        ...
        : m_opt(opt)
      {
        ...
        if ( m_opt.flags.has(TFlags::mu) )
          addhist( TFlags::mu, m_histidx_mu, nbins_angular,
                   0.0, 180.0, false );
        if ( m_opt.flags.has(TFlags::cosmu) )
          addhist( TFlags::cosmu, m_histidx_cosmu, nbins_std,
                   -1.0, 1.0, false );
        ...
        if ( m_opt.flags.has(TFlags::w) )
          addhist( TFlags::w, m_histidx_w, nbins_std,
        ...
        if ( m_opt.flags.has(TFlags::e) )
          addhist( TFlags::e, m_histidx_e, nbins_std, 0.0, 1.0, false );
        if ( m_opt.flags.has(TFlags::l) )
          addhist( TFlags::l, m_histidx_l, nbins_std, 0.0, 10.0, false );
        if ( m_opt.flags.has(TFlags::q) )
          addhist( TFlags::q, m_histidx_q, nbins_std, 0.0, 10.0, false );
