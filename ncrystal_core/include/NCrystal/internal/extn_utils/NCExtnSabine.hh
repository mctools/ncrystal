  ...
  namespace Extn {
    ...
    struct SabineMdlPurePrimary final {
                                      ...
                                      Length blockSize )
      {
        ...
        res.squared_blksize_div_v0 = ncsquare( blksz_Aa / v0 ) * 1e-8;
        return res;
      }
      ...
      static DblBasket extinctionFactor( const ModelData& md,
                                         ...
                                         const FDMBasket& fsq )
      {
        ...
        for ( auto i : ncrange( N ) )
          sabine_x[i] = nd.factor_fsq2x * fsq[i];
        ...
        for ( auto i : ncrange( N ) )
          sinth_sq[i] = nd.wlsq * ncsquare( md.inv2dsp[i] );//fixme: cache inv2dspsq ?
