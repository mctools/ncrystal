...
bool NC::MatCfg::has_extinction() const
{
  auto sv = CfgManip::get_extinction_strview( m_impl->readVar(Cfg::VarId::extinction) );
  return !sv.empty();
}
NC::ExtinctionCfgData NC::MatCfg::get_extinction() const
{
  auto sv = CfgManip::get_extinction_strview( m_impl->readVar(Cfg::VarId::extinction) );
...
void NC::MatCfg::set_extinction( const std::string& v ) { m_impl.modify()->setVar( v, &CfgManip::set_extinction_stdstr ); }
