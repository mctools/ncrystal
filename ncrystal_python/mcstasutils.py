...
def cfgstr_2_union_instrument_code( *, cfgstr, name, split_by_physics = False ):
    ...
    res = f"""
/*
   The following code was auto generated by NCrystal v{_NC.version()} via Python:
...
/* End of auto generated code from NCrystal v{_NC.version()}. */
"""
...
def cfgstr_2_hkl(*, cfgstr, tgtformat, verbose=True, fp_format = '%.14g', prefer_systemexit_exceptions = False ):
    ...
    yield f'# File created by NCrystal v{_NC.version()}'
    yield '#'
