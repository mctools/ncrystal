...
void do_tests() {
  ...
  }
  {
    ...
    {  NC::SmallVector<MyDbl,2> u{ NC::SVCountConstruct, 2 }; print(u,"SmallVector<MyDbl,3>{ SVCountConstruct, 2 } = "); }
    {  NC::SmallVector<MyDbl,2> u{ NC::SVCountConstruct, 2, 4 }; print(u,"SmallVector<MyDbl,3>{ SVCountConstruct, 2, 4 } = "); }
    {  NC::SmallVector<MyDbl,2> u{ 5 }; print(u,"SmallVector<MyDbl,3>{ 5 } = "); }
    {  NC::SmallVector<MyDbl,2> u{ 5, 4 }; print(u,"SmallVector<MyDbl,3>{ 5, 4 } = "); }
    {  NC::SmallVector<MyDbl,2> u{ 5, 4, 7 }; print(u,"SmallVector<MyDbl,3>{ 5, 4, 7 } = "); }
    {  NC::SmallVector<MyDbl,2> u{ NC::SVCountConstruct, 5 }; print(u,"SmallVector<MyDbl,3>{ SVCountConstruct, 5 } = "); }
    {  NC::SmallVector<MyDbl,2> u{ NC::SVCountConstruct, 5, 4 }; print(u,"SmallVector<MyDbl,3>{ SVCountConstruct, 5, 4 } = "); }
  }
  {
    std::cout<<"---------------------------------------"<<std::endl;
