...
void do_tests() {
  ...
  {
    NC::TinyVector<MyDblMoveOnly,15> a;
    print(a);
    a.push_back(1.0);
    print(a);
    a.push_back(2.0);
    ...
    NC::TinyVector<MyDblMoveOnly,15> c( v.begin(),v.end());
    print(c,"c");
    print(a,"a");
    ...
    print(c,"c");
    print(a,"a");
    NC::TinyVector<MyDbl,4> d = std::move(b);
    d = { 8.,7.,6.,5. };
    print(d,"d");
    ...
    NC::TinyVector<MyBigAlign,5> bigalign;
    ...
    nc_assert_always( (NC::TinyVector<MyBigAlign,3>::isFastAccess()==true) );
    nc_assert_always( (NC::TinyVector<MyDbl,3>::isFastAccess()==true) );

    nc_assert_always( (NC::TinyVector<MyBigAlign,3>::isFastAccess()==true) );
    nc_assert_always( (NC::TinyVector<float,3>::isFastAccess()==true) );
    std::cout<<"sizeof(MyBigAlign) = "<<sizeof(MyBigAlign)<<std::endl;
    std::cout<<"alignof(MyBigAlign) = "<<alignof(MyBigAlign)<<std::endl;

    NC::TinyVector<double,8> aa = { 2.0, 6.0, 8.0, 9.0, 2.1, 5., 4., 2. };
    NC::TinyVector<double,12> aaa( aa.begin(), aa.end() );
    print(aa,"aa");
    print(aaa,"aaa");
    ...
    NC::TinyVector<double,13> aaaa = { 2.0, 6.0, 8.0, 9.0, 2.1, 5., 4., 2. };
    print(aaaa,"aaaa");
    std::cout<<"sort aaaa"<<std::endl;
    std::sort(aaaa.begin(),aaaa.end());
    print(aaaa,"aaaa");

    NC::TinyVector<MyPt,30> vpt;
    NC::TinyVector<MyPt,30> vpt2;
    print(vpt,"vpt");
    nc_assert_always(vpt.capacity()==30);
    ...
    print(vpt2,"vpt2");
    nc_assert_always(vpt.capacity()==30);
    nc_assert_always(vpt2.capacity()==30);
  ...
  {
    std::cout<<"---------------------------------------"<<std::endl;
    NC::TinyVector<MyDbl,10> u = { 1, 2, 3, 4, 5, 6, 7, 8 };
    print(u,"u (TinyVector<MyDbl,NSMALL=3>) ");
    nc_assert_always((std::size_t)nalive==u.size());
    //  vpt.resize(10);
    std::cout<<"  Other(u)"<<std::endl;
    {
      NC::TinyVector<MyDbl,10> foo( u );
      nc_assert_always((std::size_t)nalive==u.size()+foo.size());
    }
    nc_assert_always((std::size_t)nalive==u.size());
    // print(u,"u");
    // nc_assert_always((std::size_t)nalive==u.size());
  ...
  {
    std::cout<<"---------------------------------------"<<std::endl;
    {  NC::TinyVector<int,2> u{ 2 }; print(u,"TinyVector<int,2>{ 2 } = "); }
    {  NC::TinyVector<int,2> u{ 2, 4 }; print(u,"TinyVector<int,2>{ 2, 4 } = "); }
    {  NC::TinyVector<int,3> u{ 2, 4, 7 }; print(u,"TinyVector<int,3>{ 2, 4, 7 } = "); }
  }
  {
    std::cout<<"---------------------------------------"<<std::endl;
    NC::TinyVector<MyDbl,6> u{1,2,3}, v{4,5,6,7,8,9};
    print(u,"u");
    print(v,"v");
  ...
  {
    std::cout<<"---------------------------------------"<<std::endl;
    NC::TinyVector<MyDbl,7> u{1,2,3}, v{4,5,6,7,8,9};
    print(u,"u");
    print(v,"v");
  ...
  NC::TinyVector<NC::TinyVector<MyDbl,7>,4> u;
  // u.resize(7);
  ...
  {
    NC::TinyVector<double,2> v_copyable = { 1.1, 2.2 };
